 ...
 *
 * Tests:
 *   1. Fetch MSPConfig and list discovered groups/themes
 *   2. Fetch telemetry and show group states (ON/OFF)
...
async function main() {
  ...
  try {
    ...
    console.log('\nFetching telemetry...\n');
    const states = await client.getGroupStates();
